...
const DICT: Dictionary = {
  ...
  'menu.performance': { en: 'Performance', no: 'Ytelse' },
  ...
  'faq.a1': { en: 'Yes, many jurisdictions tax crypto as property. Sales, trades, or purchases can trigger capital gains taxes, with short-term often taxed as income and long-term at lower rates.', no: 'Ja, i de fleste land inkludert Norge, er kryptogevinster skattepliktige når du selger, bytter eller bruker kryptovaluta.' },
  'faq.q2': { en: 'How do you report crypto on taxes?', no: 'Hvordan rapporterer du krypto på skatten?' },
  'faq.a2': { en: 'Track taxable events (sales/trades/earnings). Report capital gains and crypto income on the relevant forms. Keep detailed records or use software to ensure accuracy.', no: 'Du må rapportere alle kryptotransaksjoner inkludert salg, bytter og inntekter. Bruk skattemeldingen for å rapportere gevinst og tap.' },
  ...
  'faq.a3': { en: "Generally no for simple buy-and-hold. Earnings (staking, mining, airdrops) are typically taxed as income even if you don't sell.", no: 'Generelt ikke, men du må rapportere krypto mottatt som inntekt, staking-belønninger, mining-belønninger og airdrops uavhengig av om du selger.' },
  'faq.q4': { en: 'When do you pay taxes on crypto?', no: 'Når betaler du skatt på krypto?' },
  'faq.a4': { en: 'Common taxable events: selling for fiat, trading for other crypto, purchases with crypto, and income from forks/mining/staking/yield. Timing and rules vary by country.', no: 'Du skylder skatt når du disponerer kryptovaluta gjennom salg, bytting eller bruk til å kjøpe varer og tjenester.' },
  'faq.q5': { en: 'How much tax do you have to pay on crypto?', no: 'Hvor mye skatt må du betale på krypto?' },
  'faq.a5': { en: 'Rates depend on holding period and income bracket. Short-term often taxed as ordinary income; long-term rates are usually lower. Crypto income is taxed at your regular rate.', no: 'Skattesatser avhenger av hvor lenge du holdt kryptoen og inntektsnivået ditt. Kortsiktige gevinster (under 1 år) beskattes som alminnelig inntekt.' },
  'faq.q6': { en: 'How does tax software help with my crypto taxes?', no: 'Hvordan hjelper skatteprogramvare med kryptoskatten?' },
  'faq.a6': { en: 'Software automates tracking, calculates gains/losses, and prepares forms. Syncing exchanges and wallets reduces errors and saves time.', no: 'Kryptoskatteprogramvare importerer automatisk transaksjonene dine, beregner gevinst og tap, og genererer nødvendige skatteskjemaer.' },
  ...
  // Wallets
  'wallets.syncAll': { en: 'Sync All', no: 'Synkroniser' },
  ...
  // New structured headline
  'landing.hero.title.before': { en: 'Crypto made simple — get', no: 'Krypto gjort enkelt – få' },
  'landing.hero.title.highlight': { en: 'overview', no: 'oversikt' },
  'landing.hero.title.after': { en: 'of taxes and portfolio', no: 'over skatt og portefølje' },
  // Updated hero description
  'landing.hero.desc': { en: 'Connect wallets and exchanges, get an overview of your assets, and generate accurate tax reports. Take control of your holdings.', no: 'Koble til lommebøker og børser, få oversikt over eiendelene dine og lag nøyaktige skattemeldinger. Ta kontroll over din beholdning.' },
  'landing.hero.cta': { en: 'Get started', no: 'Kom i gang' },
  'landing.hero.ctaFree': { en: 'Create a free account', no: 'Registrer gratis bruker' },
  ...
  'landing.everythingDesc': { en: 'Focus on your crypto strategy, not complicated calculations. We handle tax reports and portfolio overviews for you.', no: 'Fokuser på din kryptostrategi, ikke kompliserte beregninger. Vi tar oss av skatterapporter og porteføljeoversikt.' },
  'landing.feature.tax.title': { en: 'Simplified Tax Reporting', no: 'Skattekalkulator' },
  'landing.feature.tax.desc': { en: 'Generate comprehensive tax reports compatible with tax software. Calculate capital gains and losses effortlessly.', no: 'Beregn hvor mye du skal betale i skatt og generer detaljerte skatterapporter.' },
  'landing.feature.tracking.title': { en: 'Automatic Portfolio Tracking', no: 'Porteføljeoversikt' },
  'landing.feature.tracking.desc': { en: 'Connect your wallets and exchanges to automatically sync transactions and track your crypto portfolio value in real time.', no: 'Koble til lommebøker og børser for sanntidsoversikt av din portefølje.' },
  'landing.feature.overview.title': { en: 'Comprehensive Asset Overview', no: 'Ytelsesindikatorer' },
  'landing.feature.overview.desc': { en: 'View all your crypto assets across different wallets and blockchains in one unified dashboard.', no: 'Følg porteføljens prestasjon og sammenlign med markedsindekser.' },
  'landing.feature.secure.title': { en: 'Secure & Private', no: 'Skattetapsrealisering' },
  'landing.feature.secure.desc': { en: 'Your financial data matters. We prioritize security and privacy in handling your information.', no: 'Identifiser muligheter for å realisere tap og redusere skattegrunnlag.' },
  ...
  'landing.bottom.question': { en: 'Haven’t created a free account yet?', no: 'Har du enda ikke registrert en gratis bruker?' },
